...
@SpringBootTest
@Transactional
public class SearchCocktailByIngredientControllerTest {

    @Autowired
    SearchCocktailByIngredientController searchCocktailByIngredientController;
    ...
    @Test
    public void testFindCocktailByStrIngredient() {
